...
## Quick Start
    ...
    # ..put the correct tokens into composer.env and docker-compose.yml
    
    mkdir src
    # your folder src must be create vs your user and group
    ...
    sudo nano /etc/hosts
    #add 127.0.0.1      labelin.docker
    #site is avaible on http://labelin.docker:8080/
...
##Delete all docker images containers caches
    docker system prune -a
    # reinstall keys docker after
